        ...
        if (el && !sortableInstance) {
          sortableInstance = Sortable.create(el, {
            ...
            onEnd({ oldIndex: oldIndex2, newIndex: newIndex2 }) {
              if (oldIndex2 == null || newIndex2 == null || oldIndex2 === newIndex2) return;
              const items = [...files.value];
              const [moved2] = items.splice(oldIndex2, 1);
              items.splice(newIndex2, 0, moved2);
              files.value = items;
              saveSortOrder();
            }
          });
